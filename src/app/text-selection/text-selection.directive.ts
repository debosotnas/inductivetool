// customized version of text-selection from
// https://github.com/bennadel/JavaScript-Demos/blob/master/demos/selection-range-directive-angular5/app/text-select.directive.ts
